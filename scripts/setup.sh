...
check_termux() {
    if [ ! -d "/data/data/com.termux" ]; then
        ...
        echo ""
        echo -e "${RED}Do NOT use the Google Play Store version.${NC}"
        exit 1
    fi
...
finish_standalone() {
    ...
    echo -e "    ${CYAN}curl -fsSL https://raw.githubusercontent.com/Sidharth-e/MOMOS/main/scripts/momos.sh | bash${NC}"
    echo ""
